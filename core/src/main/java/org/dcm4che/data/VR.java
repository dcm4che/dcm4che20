 ...
 */
public enum VR {
    AE(0x4145, true, StringVR.AE, 0x20),
    AS(0x4153, true, StringVR.AS, 0x20),
    AT(0x4154, true, BinaryVR.AT, 0),
    CS(0x4353, true, StringVR.CS, 0x20),
    DA(0x4441, true, StringVR.DA, 0x20),
    DS(0x4453, true, StringVR.DS, 0x20),
    DT(0x4454, true, StringVR.DT, 0x20),
    FD(0x4644, true, BinaryVR.FD, 0),
    FL(0x464c, true, BinaryVR.FL, 0),
    IS(0x4953, true, StringVR.IS, 0x20),
    LO(0x4c4f, true, StringVR.LO, 0x20),
    LT(0x4c54, true, StringVR.LT, 0x20),
    OB(0x4f42, false, BinaryVR.OB, 0),
    OD(0x4f44, false, BinaryVR.OD, 0),
    OF(0x4f46, false, BinaryVR.OF, 0),
    OL(0x4f4c, false, BinaryVR.OL, 0),
    OW(0x4f57, false, BinaryVR.OW, 0),
    PN(0x504e, true, StringVR.PN, 0x20),
    SH(0x5348, true, StringVR.SH, 0x20),
    SL(0x534c, true, BinaryVR.SL, 0),
    SQ(0x5351, false, SequenceVR.SQ, 0),
    SS(0x5353, true, BinaryVR.SS, 0),
    ST(0x5354, true, StringVR.ST, 0x20),
    TM(0x544d, true, StringVR.TM, 0x20),
    UC(0x5543, false, StringVR.UC, 0x20),
    UI(0x5549, true, StringVR.UI, 0),
    UL(0x554c, true, BinaryVR.UL, 0),
    UN(0x554e, false, BinaryVR.UN, 0),
    UR(0x5552, false, StringVR.UR, 0x20),
    US(0x5553, true, BinaryVR.US, 0x20),
    UT(0x5554, false, StringVR.UT, 0),
    NONE(-1, true, null, 0);
